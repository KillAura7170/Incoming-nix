package me.alpha432.oyvey.features.modules.troll;
...
public class PenisESP
    ...
    public PenisESP() {
        super("BestModule", "caution:ur pp is small", Module.Category.TROLL, false, false, false);
    }
    ...
    public void esp(final EntityPlayer player, final double x, final double y, final double z) {
        ...
        shaft.draw(0.1f * this.penisSize.getValue(true), 0.11f, 0.4f, 25, 20);
        ...
        right.draw(0.14f * this.penisSize.getValue(true), 10, 20);
        GL11.glTranslated(0.16000000149011612, 0.0, 0.0);
        final Sphere left = new Sphere();
        left.setDrawStyle(100013);
        left.draw(0.14f * this.penisSize.getValue(true), 10, 20);
        ...
        tip.draw(0.13f * this.penisSize.getValue(true), 15, 20);
        GL11.glDepthMask(true);
        GL11.glDisable(2848);
        GL11.glEnable(2929);
        GL11.glDisable(3042);
