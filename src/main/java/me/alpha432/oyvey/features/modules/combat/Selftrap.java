...
public class Selftrap
    ...
    @Override
    public void onTick() {
        if (this.isOn() && (this.blocksPerTick.getValue(true) != 1 || !this.rotate.getValue(true))) {
            this.doHoleFill();
        }
    }
    ...
    public void onUpdateWalkingPlayer(UpdateWalkingPlayerEvent event) {
        if (this.isOn() && event.getStage() == 0 && this.blocksPerTick.getValue(true) == 1 && this.rotate.getValue(true)) {
            this.doHoleFill();
        }
    }
    ...
    private void placeBlock(BlockPos pos) {
        if (this.blocksThisTick < this.blocksPerTick.getValue(true)) {
            boolean smartRotate = this.blocksPerTick.getValue(true) == 1 && this.rotate.getValue(true);
    ...
    private boolean check() {
        ...
        if (this.disable.getValue(true) && this.offTimer.passedMs(this.disableTime.getValue(true))) {
            this.disable();
            return true;
        }
