...
public class Replenish extends Module {
    ...
    public Replenish() {
        ...
        this.gapStack = (Setting<Integer>) this.register(new Setting("GapStack", 16, 1, 64));
        this.xpStackAt = (Setting<Integer>) this.register(new Setting("XPStack", 16, 1, 64));
        this.crystalStack = (Setting<Integer>) this.register(new Setting("CrystalStack", 16, 1, 64));
