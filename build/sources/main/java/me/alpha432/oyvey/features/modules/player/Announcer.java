...
public class Announcer extends Module {
    ...
    public static String walkMessage = "I just moved {blocks} blocks thanks to Incoming";
    public static String breakMessage = "I just broke {amount} {name} thanks to Incoming";
    public static String eatMessage = "I just ate {amount} {name} thanks to Incoming";
