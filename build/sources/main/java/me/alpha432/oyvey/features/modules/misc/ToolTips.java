...
public class ToolTips
    ...
    public void renderShulkerToolTip(ItemStack stack, int x, int y, String name) {
        ...
        if (tagCompound != null && tagCompound.hasKey("BlockEntityTag", 10) && (blockEntityTag = tagCompound.getCompoundTag("BlockEntityTag")).hasKey("Items", 9)) {
            ...
            Color color = new Color(ClickGui.getInstance().red.getValue(true), ClickGui.getInstance().green.getValue(true), ClickGui.getInstance().blue.getValue(true), 200);
            ...
            NonNullList nonnulllist = NonNullList.withSize(27, (net.minecraftforge.common.capabilities.ICapabilitySerializable<NBTTagCompound>) ItemStack.EMPTY);
