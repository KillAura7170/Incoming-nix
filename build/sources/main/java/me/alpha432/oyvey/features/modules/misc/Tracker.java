...
public class Tracker
    ...
    public void onUpdate() {
        if (this.trackedPlayer == null) {
            ...
            Command.sendMessage(TextUtil.coloredString(this.trackedPlayer.getName() + " has used " + this.usedStacks + " stacks of XP!", HUD.getInstance().commandColor.getValue(true)));
        }
    }
