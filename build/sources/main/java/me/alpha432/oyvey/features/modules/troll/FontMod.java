...
import me.alpha432.oyvey.features.modules.troll.FontMod;
...
public class FontMod extends Module {
    ...
    public FontMod() {
        super("CustomFont", "CustomFont for all of the clients text. Use the font command.", Module.Category.TROLL, true, false, false);
        setInstance();
    }
