...
public class FakePlayer extends Module {
    public Setting<Boolean> hollow = this.register(new Setting("OP_Niggaura", false));
    ...
    public void onEnable() {
        ...
        if (otherPlayer == null) {
            otherPlayer = new EntityOtherPlayerMP(mc.world, new GameProfile(UUID.randomUUID(), "OP_Niggaura"));
