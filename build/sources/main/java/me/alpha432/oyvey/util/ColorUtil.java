...
public class ColorUtil {
    ...
    public static Color rainbow(int delay) {
        ...
        return Color.getHSBColor((float) ((rainbowState %= 360.0) / 360.0), ClickGui.getInstance().rainbowSaturation.getValue(true) / 255.0f, ClickGui.getInstance().rainbowBrightness.getValue(true) / 255.0f);
    }
